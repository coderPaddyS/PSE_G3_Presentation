...
\begin{frame}\frametitle{Allgemeiner Eindruck}
    \begin{minipage}{\textwidth}
        \begin{minipage}{.49\textwidth}
            \inprelimg[height=0.6\textheight]{overall_impression}
        \end{minipage}
        \begin{minipage}{.49\textwidth}
            \textbf{Legende} 
            \begin{tabular}{l l}
...
\begin{frame}\frametitle{Hilfreich für Studenten}
    \begin{minipage}{\textwidth}
        \begin{minipage}{.49\textwidth}
            \inprelimg[height=0.6\textheight]{helpful_for_students}
        \end{minipage}
        \begin{minipage}{.49\textwidth}
            \textbf{Legende} 
            \begin{tabular}{l l}
...
\begin{frame}\frametitle{Nutzung nach Veröffentlichung}
    \begin{minipage}{\textwidth}
        \begin{minipage}{.49\textwidth}
            \inprelimg[height=0.6\textheight]{usage}
        \end{minipage}
        \begin{minipage}{.49\textwidth}
            \textbf{Legende} 
            \begin{tabular}{l l}
...
\begin{frame}\frametitle{Empfehlung für andere Studierende}
    \begin{minipage}{\textwidth}
        \begin{minipage}{.49\textwidth}
            \inprelimg[height=0.6\textheight]{recommended}
        \end{minipage}
        \begin{minipage}{.49\textwidth}
            \textbf{Legende} 
            \begin{tabular}{l l}
